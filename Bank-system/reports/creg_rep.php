...
function Header()
{
    ...
    $this->Cell(80);
    // Title
    $this->Cell(30,10,'registered bank clerks',0,0,'C');
    // Line break
    $this->Ln(20);
}
// Page footer
...
$sqli="SELECT fname,lname,AccNo,is_customer,date from users where  is_clerk= 1 and date BETWEEN '$st_date' AND '$en_date' " ;
