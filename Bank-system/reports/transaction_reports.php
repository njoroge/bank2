      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <li><a class="nav-item nav-link active" href="transaction_reports.php">Transaction Reports </a></li>
            <li><a class="nav-item nav-link " href="ministatement.php">Mini-statements </a></li>
