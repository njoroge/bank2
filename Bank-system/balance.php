                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                                        <div class="navbar-nav">
                                                ...
                                                <li><a class="nav-item nav-link active" href="balance.php">balance </a></li>
                                                <li><a class="nav-item nav-link" href="change_pin.php">Change pin</a></li>
                ...
                <div class="row">
                        ...
                        <div class="col-md">
                                ...
                                <form action="report.php">
                                        <button type="submit" class="reportsbtn" name="reports">click here</button>
                                </form>
                        </div>
</body>
